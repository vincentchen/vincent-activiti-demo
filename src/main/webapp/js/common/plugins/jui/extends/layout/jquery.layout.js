...
(function ($) {
    ...
    $.fn.layout = function (opts) {
        ...
        var config = {
            allPanes: "north,south,east,west,center", borderPanes: "north,south,east,west", zIndex: { // set z-index values here
                ...
                edge: "top", sizeType: "height", dir: "horz", cssReq: {
                    top: 0, bottom: "auto", left: 0, right: 0, width: "auto"
                    //	height: 	DYNAMIC
                }
            }, south: {
                edge: "bottom", sizeType: "height", dir: "horz", cssReq: {
                    top: "auto", bottom: 0, left: 0, right: 0, width: "auto"
                    //	height: 	DYNAMIC
                }
            }, east: {
                edge: "right", sizeType: "width", dir: "vert", cssReq: {
                ...
                edge: "left", sizeType: "width", dir: "vert", cssReq: {
        ...
        var state = {
            ...
            id: Math.floor(Math.random() * 10000), container: {}, north: {}, south: {}, east: {}, west: {}, center: {}
        };
        ...
        var initContainer = function () {
            try { // format html/body if this is a full page layout
                if ($Container[0].tagName == "BODY") {
                    ...
                    $("body").css({
                        position: "relative", height: "100%", overflow: "hidden", margin: 0, padding: 0		// TODO: test whether body-padding could be handled?
        ...
        var initResizable = function () {
            ...
            $.each(c.borderPanes.split(","), function () {
                ...
                $R.draggable({
                    ...
                    , delay: 200, distance: 1
                    //	basic format for helper - style it using class: .ui-draggable-dragging
                    , helper: "clone", opacity: o.resizerDragOpacity
                    //,	iframeFix:		o.draggableIframeFix // TODO: consider using when bug is fixed
                    , zIndex: c.zIndex.resizing, start: function (e, ui) {
                        ...
                        $(o.maskIframesOnResize === true ? "iframe" : o.maskIframesOnResize).each(function () {
                            $('<div class="ui-layout-mask"/>')
                                .css({
                                    background: "#fff", opacity: "0.001", zIndex: 9, position: "absolute", width: this.offsetWidth + "px", height: this.offsetHeight + "px"
                                })
